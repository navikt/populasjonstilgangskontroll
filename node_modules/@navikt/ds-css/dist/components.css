...
@layer aksel.components.core {
  .aksel-theme {
    color: var(--ax-text-neutral);
  }

  .aksel-theme[data-background="true"] {
  ...
  .aksel-chips__chip:focus-visible {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: 3px;
  }

  .aksel-chips--readonly .aksel-chips__chip {
    background-color: var(--ax-bg-neutral-moderateA);
  }

  .aksel-chips--small .aksel-chips__chip {
    min-height: 1.5rem;
    padding: 0 var(--ax-space-8);
  }

  .aksel-chips--small .aksel-chips__toggle-icon {
    width: 1rem;
    height: 1rem;
  }

  .aksel-chips--small .aksel-chips__toggle--with-checkmark {
    padding-left: var(--ax-space-4);
  }

  .aksel-chips--small .aksel-chips__removable-icon {
    width: 1.25rem;
    height: 1.25rem;
  }

  .aksel-chips--small .aksel-chips__removable-icon > svg {
    width: 1rem;
  }

  .aksel-chips--small .aksel-chips--icon-right {
...
@layer aksel.components.core.loader {
  .aksel-loader {
    stroke-width: 6px;
...
@layer aksel.components.core.button {
  ...
  .aksel-button[data-variant="secondary"]:is(:disabled, .aksel-button--disabled)[data-color="neutral"], [data-color="neutral"] > .aksel-button[data-variant="secondary"]:is(:disabled, .aksel-button--disabled):not([data-color]) {
    color: var(--ax-text-default);
  }
  ...
  .aksel-button[data-variant="tertiary"]:is(:disabled, .aksel-button--disabled)[data-color="neutral"], [data-color="neutral"] > .aksel-button[data-variant="tertiary"]:is(:disabled, .aksel-button--disabled):not([data-color]) {
    color: var(--ax-text-default);
  }
...
@layer aksel.components.form {
  ...
  .aksel-search__button-search[data-variant="secondary"]:hover:not(:disabled) {
    --__axc-button-border-color: var(--ax-border-strong);
  }
...
@layer aksel.components.modules {
  ...
  .aksel-accordion__item[data-expanded="true"] > .aksel-accordion__header:after, .aksel-accordion__item:not(:last-child) > .aksel-accordion__header:after, .aksel-accordion__item[data-expanded="false"]:has(.aksel-accordion__header:where(:hover, :focus-visible)) + .aksel-accordion__item > .aksel-accordion__header:before {
    display: none;
  }
  ...
  .aksel-base-alert[data-centered="false"] {
  ...
  .aksel-base-alert[data-size="small"][data-centered="false"] {
  ...
  .aksel-chat--right .aksel-chat__bubble-wrapper {
    align-items: flex-end;
  }
  ...
  .aksel-chat--top-text-right .aksel-chat__top-text, .aksel-chat--left .aksel-chat__top-text--right {
    align-self: flex-end;
  }
  ...
  .aksel-date .aksel-date__caption-label {
    text-transform: capitalize;
  }

  .aksel-date .rdp-head_cell {
    text-transform: capitalize;
    font-size: var(--ax-font-size-small);
  }
  ...
  :is(.aksel-date .rdp-button:where(:not(.rdp-day_selected, [disabled])):hover, .aksel-date .aksel-date__month-button:where(:not(.rdp-day_selected, [disabled])):hover) .rdp-day__inner {
  ...
  :is(:is(.aksel-date__wrapper, .aksel-date__standalone-wrapper) .rdp-cell > button.rdp-day, :is(.aksel-date__wrapper, .aksel-date__standalone-wrapper) button.aksel-date__month-button):focus-visible .rdp-day__inner {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: 3px;
  }

  :is(:is(.aksel-date__wrapper, .aksel-date__standalone-wrapper) .rdp-cell > button.rdp-day, :is(.aksel-date__wrapper, .aksel-date__standalone-wrapper) button.aksel-date__month-button):active:not(:disabled) .rdp-day__inner {
    color: var(--ax-text-contrast);
    background-color: var(--ax-bg-strong-pressed);
  }
  ...
  .aksel-date__field:not(.aksel-date__field--readonly):has(.aksel-date__field-input:not(:disabled)) .aksel-date__field-button:hover, .aksel-date__field:not(.aksel-date__field--readonly, .aksel-date__field--error):has(.aksel-date__field-input:is(:focus-visible, :hover):not(:disabled)) .aksel-date__field-button {
    --__axc-button-border-color: var(--ax-border-strong);
  }
  ...
  .aksel-form-field--disabled .aksel-date__field-button {
    opacity: 1;
    cursor: not-allowed;
  }
  ...
  .aksel-data-table[data-zebra-stripes="true"] .aksel-data-table__tbody :where(.aksel-data-table__tr:nth-child(2n)) {
    --__axc-data-table-zebra-color: var(--ax-bg-neutral-soft);
    background-color: var(--__axc-data-table-zebra-color);
  }

  .aksel-data-table[data-zebra-stripes="true"] .aksel-data-table__tbody :where(.aksel-data-table__tr:nth-child(2n))[data-selected="true"] {
  ...
  .aksel-data-table__thead .aksel-data-table__cell, .aksel-data-table[data-column-dividers="true"] .aksel-data-table__cell {
    box-shadow: inset 1px 1px 0 0 var(--ax-border-neutral-subtle);
  }

  .aksel-data-table__cell:not(.aksel-data-table__column-header, [data-sticky]) {
    overflow: hidden;
  }
  ...
  .dark .aksel-data-table__cell[data-sticky] {
  ...
  .aksel-data-table__drag-and-drop-item {
    ...
    padding-block: var(--ax-space-4);
    flex-wrap: nowrap;
    margin-inline-start: calc(-1 * var(--ax-space-2));
    display: flex;
  }
  ...
  .aksel-data-table__drag-and-drop-item[data-drop-target="true"]:not([data-overlay="true"]) {
    ...
    box-shadow: 0 -1px 0 0 var(--ax-border-neutral-strong);
  }
  ...
  .aksel-data-grid__preferences-body {
    flex-grow: 1;
  }

  .aksel-data-grid__preferences-content {
    align-content: flex-start;
    gap: var(--ax-space-16) var(--ax-space-48);
  ...
  .aksel-data-grid__preferences-block {
    gap: var(--ax-space-16);
    flex-direction: column;
    display: flex;
  }
  ...
  .aksel-dialog__popup {
    ...
    --__axc-dialog-p-i: var(--ax-space-20);
    background-color: var(--ax-bg-raised);
    border-radius: var(--ax-radius-12);
    color: var(--ax-text-neutral);
    box-shadow: var(--ax-shadow-dialog);
    ...
    z-index: 2000;
    flex-direction: column;
    transition: transform .2s cubic-bezier(.25, .46, .45, .94), opacity .2s cubic-bezier(.25, .46, .45, .94), translate .2s cubic-bezier(.25, .46, .45, .94);
    display: flex;
    position: fixed;
    overflow: hidden;
  }

  .aksel-dialog__popup:focus {
    outline: none;
  }

  .aksel-dialog__popup[data-size="small"] {
    --__axc-dialog-p-b: var(--ax-space-12);
  ...
  .aksel-dialog__popup[data-exiting-style]:after {
    transition-timing-function: cubic-bezier(.55, .09, .68, .53);
  }

  .aksel-dialog__popup[data-nested-dialog-open="true"] {
    box-shadow: none;
  }

  .aksel-dialog__popup[data-nested-dialog-open="true"]:after {
    opacity: .9;
  }

  .aksel-dialog__popup:after {
    content: "";
    border-radius: inherit;
    background-color: var(--ax-bg-overlay);
    opacity: 0;
  ...
  .aksel-dialog__popup[data-position="center"] {
    --__axc-dialog-center-margin: 3rem;
  ...
  .aksel-dialog__popup[data-position="center"][data-nested-dialog-open="true"] {
  ...
  .aksel-dialog__popup[data-position="right"] {
    --__axc-dialog-transform: translateX(35%);
    border-right: 0;
    border-top-right-radius: 0;
    border-bottom-right-radius: 0;
    right: 0;
  ...
  .aksel-dialog__popup[data-position="bottom"] {
    --__axc-dialog-transform: translateY(35%);
    border-bottom: 0;
    border-bottom-right-radius: 0;
    border-bottom-left-radius: 0;
  ...
  .aksel-dialog__popup[data-position="bottom"][data-nested-dialog-open="true"] {
    transform: translateY(calc(1rem * var(--__axc-nested-level) * -1)) scale(calc(1 - .02 * var(--__axc-nested-level)));
  }

  .aksel-dialog__popup[data-position="fullscreen"] {
    --__axc-dialog-transform: scale(.98);
    border: 0;
    border-radius: 0;
    width: 100%;
  ...
  @media (forced-colors: active) {
    .aksel-dialog__popup {
      outline: 2px solid var(--ax-border-neutral-strong) !important;
    }
  }
  ...
  .aksel-action-menu__content {
    ...
    transition: transform .15s ease allow-discrete,
    opacity .15s ease allow-discrete;
    overflow: hidden;
  }

  @starting-style {
    .aksel-action-menu__content[data-state="open"] {
      opacity: .8;
  ...
  .aksel-action-menu__item[aria-disabled="true"] {
    opacity: .5;
    pointer-events: none;
  }
  ...
  .aksel-action-menu__sub-trigger[data-state="open"] {
  ...
  .aksel-action-menu__item--danger:focus {
  ...
  .aksel-action-menu__marker-icon.aksel-action-menu__marker--right {
    margin-left: 0;
    padding-left: 0;
  }
  ...
  .aksel-action-menu__indicator-icon--unchecked, .aksel-action-menu__indicator-icon--checked, .aksel-action-menu__indicator-icon--indeterminate {
    display: none;
  }
  ...
  .aksel-expansioncard--small > .aksel-expansioncard__header > .aksel-expansioncard__header-button {
    min-width: 2rem;
    min-height: 2rem;
  }
  ...
  .aksel-expansioncard__header[data-open="true"]:hover:after {
    opacity: 0;
  }
  ...
  .aksel-expansioncard__header-button:focus-visible {
    outline: 3px solid var(--ax-border-focus);
  }

  .aksel-expansioncard__header-button:after {
    z-index: 1;
    content: "";
    cursor: pointer;
    opacity: 0;
  ...
  .aksel-expansioncard__content[data-open="true"] .aksel-expansioncard__content-inner {
    opacity: 1;
  }
  ...
  .aksel-guide-panel[data-poster="false"][data-responsive="false"] {
  ...
  .aksel-guide svg, .aksel-guide img {
    width: 100%;
    height: 100%;
  }
  ...
  .aksel-guide-panel[data-poster="false"] > .aksel-guide-panel__content {
    margin-left: var(--ax-space-20);
  }

  @media (min-width: 480px) {
    .aksel-guide-panel[data-responsive="true"] > .aksel-guide-panel__content {
      margin-top: 0;
      margin-left: var(--ax-space-20);
    }
  }
  ...
  .aksel-guide-panel[data-poster="false"] .aksel-guide-panel__content-inner {
  ...
  @media (min-width: 480px) {
    .aksel-guide-panel[data-responsive="true"] .aksel-guide-panel__tail {
      top: calc(var(--__axc-guide-panel-guide-size) / 2);
      left: calc(var(--ax-space-20) * -1 - 2px);
      transform: translateY(-15%) rotateZ(-90deg) scaleX(-1);
    }
  ...
  .aksel-internalheader__title:hover {
  ...
  :is(.aksel-internalheader__title, .aksel-internalheader__button):focus-visible {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: -4px;
  }

  :is(.aksel-internalheader__title, .aksel-internalheader__button):active {
  ...
  .aksel-link.aksel-link--inline-text > svg {
  ...
  .aksel-link.aksel-link--remove-underline {
    text-decoration: none;
  }

  .aksel-link.aksel-link--remove-underline:hover {
    text-decoration: underline;
  }
  ...
  .aksel-link-panel:hover {
    border-color: var(--ax-border-accent);
  }

  .aksel-link-panel:hover .aksel-link-panel__title {
    color: var(--ax-text-accent-subtle);
    text-decoration: underline;
  }

  .aksel-link-panel:focus-visible {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: 3px;
  }
  ...
  .aksel-link-panel:hover > .aksel-link-panel__chevron, .aksel-link-panel:focus-within > .aksel-link-panel__chevron {
  ...
  .aksel-modal[open] {
    flex-direction: column;
    animation: .7s cubic-bezier(.15, 1, .3, 1) akselModalFadeIn;
    display: flex;
  }
  ...
  .aksel-modal::backdrop {
    ...
    animation: .7s cubic-bezier(.15, 1, .3, 1) akselModalBackdropFadeIn;
  }
  ...
  .aksel-tag:has(.aksel-tag__icon--left) {
    gap: var(--ax-space-2);
  }
  ...
  .aksel-read-more__button:focus-visible {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: 3px;
  }
  ...
  .aksel-progress-bar__foreground--indeterminate {
    ...
    animation-duration: var(--__axc-progress-bar-simulated), 2.5s;
  ...
  .aksel-skeleton--has-children.aksel-skeleton--no-height {
    height: auto;
  }
  ...
  .aksel-process__event[data-status="active"] .aksel-process__bullet {
    ...
    outline: 2px solid var(--ax-bg-strong);
    outline-offset: 2px;
  }
  ...
  .aksel-stepper__item:has( + .aksel-stepper__item > .aksel-stepper__step[data-interactive="false"]) .aksel-stepper__line--2 {
    background-color: var(--ax-border-neutral-strong);
  }
  ...
  .aksel-stepper__item:last-of-type .aksel-stepper__line--2 {
    display: none;
  }
  ...
  .aksel-stepper__step:focus-visible {
    outline: 3px solid var(--ax-border-focus);
    outline-offset: 3px;
    isolation: isolate;
  }

  .aksel-stepper__item:last-child .aksel-stepper__step {
    margin-bottom: 0;
  }
  ...
  .aksel-stepper__circle--success {
    font-size: calc(var(--__axc-stepper-circle-size) * .75);
    background: none;
  }
  ...
  .aksel-stepper__step[data-interactive="true"] .aksel-stepper__content {
    text-underline-offset: .1em;
    text-decoration: underline;
    text-decoration-thickness: .05em;
  }
  ...
  .aksel-stepper__step[data-interactive="false"] .aksel-stepper__circle {
    border-color: var(--ax-border-neutral-strong);
  }

  .aksel-stepper__step[data-interactive="false"][data-active="true"] .aksel-stepper__circle {
    color: var(--ax-text-neutral-contrast);
  ...
  .aksel-stepper[data-orientation="horizontal"] .aksel-stepper__line {
  ...
  .aksel-stepper[data-orientation="horizontal"] .aksel-stepper__line--1 {
    grid-column: line-1;
  }

  .aksel-stepper[data-orientation="horizontal"] .aksel-stepper__line--2 {
    grid-column: line-2;
  }
  ...
  .aksel-stepper[data-orientation="horizontal"] .aksel-stepper__circle {
    grid-area: circle / 2;
  }

  .aksel-stepper[data-orientation="horizontal"] .aksel-stepper__content {
    grid-area: content / 1 / content / -1;
    max-width: 24ch;
  }
  ...
  @media (forced-colors: active) {
    ...
    .aksel-stepper__step[data-active="true"][data-interactive] .aksel-stepper__circle {
      forced-color-adjust: none;
      color: highlighttext;
      background-color: highlight;
    }
  ...
  .aksel-table__body .aksel-table__row--shade-on-hover:hover {
    background-color: var(--ax-bg-neutral-moderate-hoverA);
  ...
  .aksel-table--zebra-stripes .aksel-table__body :where(.aksel-table__expandable-row:nth-child(4n+1):not(.aksel-table__row--selected)) {
    background-color: rgba(0, 0, 0, 0);
  }

  .aksel-table--zebra-stripes .aksel-table__body .aksel-table__expanded-row:nth-child(4n) {
    background-color: var(--ax-bg-neutral-softA);
  }
  ...
  .aksel-table__header .aksel-table__header-cell, .aksel-table__header .aksel-table__data-cell {
    border-bottom-width: 2px;
  }

  .aksel-table__header-cell--align-right, .aksel-table__data-cell--align-right {
    text-align: right;
  }

  .aksel-table__header-cell--align-center, .aksel-table__data-cell--align-center {
    text-align: center;
  }
  ...
  .aksel-table--large .aksel-table__header-cell, .aksel-table--large .aksel-table__data-cell {
    padding: var(--ax-space-16) var(--ax-space-8);
  }

  .aksel-table--small .aksel-table__header-cell, .aksel-table--small .aksel-table__data-cell {
  ...
  .aksel-table__toggle-expand-button:hover, .aksel-table__toggle-expand-cell:hover > .aksel-table__toggle-expand-button, .aksel-table__expandable-row--clickable:hover .aksel-table__toggle-expand-button {
    background-color: var(--ax-bg-neutral-moderate-hoverA);
  }
  ...
  .aksel-table__expanded-row-cell:empty {
    display: none;
  }

  .aksel-table__expanded-row-collapse:not([style*="height: 0px;"]), .aksel-table__expanded-row-collapse[style*="transition:"] {
    border-bottom: 1px solid var(--ax-border-neutral-subtleA);
  }
  ...
  .aksel-tabs__tablist::-webkit-scrollbar {
    display: none;
  }
  ...
  .aksel-tabs__scroll-button svg {
    flex-shrink: 0;
    font-size: 1.25rem;
  }

  .aksel-tabs--small .aksel-tabs__scroll-button {
  ...
  .aksel-tabs__tab-inner svg {
    flex-shrink: 0;
  }

  .aksel-tabs__tab-icon--top > .aksel-tabs__tab-inner {
    flex-direction: column;
    gap: 0;
  }
  ...
  .aksel-tabs__tab-icon--top, .aksel-tabs__tab--small.aksel-tabs__tab-icon--top {
  ...
  :is(.aksel-tabs__tab--icon-only, .aksel-tabs__tab-icon--top) svg {
    font-size: 1.5rem;
  }
  ...
  .aksel-list ul, .aksel-list ol {
    margin: 0;
    padding: 0;
  }

  .aksel-list .aksel-list :where(ul, ol) {
  ...
  .aksel-list ol li::marker {
    font-weight: var(--ax-font-weight-bold);
  }

  .aksel-list ul > .aksel-list__item {
    gap: var(--ax-space-8);
    grid-template-columns: auto 1fr;
    display: grid;
  }

  .aksel-list ul > li > .aksel-list__item-marker {
    height: var(--ax-font-line-height-xlarge);
    align-items: center;
    display: flex;
  }
