...
@layer aksel.theming {
  :root, :host, .light {
    ...
    --ax-neutral-000: white;
    --ax-neutral-100A: rgba(0, 26, 51, .04);
    --ax-neutral-200A: rgba(0, 14, 41, .075);
    --ax-neutral-300A: rgba(0, 17, 51, .118);
    ...
    --ax-accent-100A: rgba(0, 110, 255, .055);
    --ax-accent-200A: rgba(0, 95, 255, .106);
    --ax-accent-300A: rgba(1, 101, 244, .17);
    --ax-accent-400A: rgba(0, 100, 241, .27);
    ...
    --ax-success-100A: rgba(0, 238, 53, .114);
    --ax-success-200A: rgba(0, 201, 37, .165);
    --ax-success-300A: rgba(1, 178, 39, .23);
    --ax-success-400A: rgba(0, 162, 36, .34);
    ...
    --ax-warning-100A: rgba(255, 161, 0, .106);
    --ax-warning-200A: rgba(255, 164, 0, .22);
    --ax-warning-300A: rgba(255, 162, 1, .353);
    --ax-warning-400A: rgba(255, 163, 0, .565);
    ...
    --ax-danger-100A: rgba(255, 0, 99, .05);
    --ax-danger-200A: rgba(255, 0, 89, .09);
    --ax-danger-300A: rgba(255, 0, 88, .15);
    --ax-danger-400A: rgba(255, 0, 88, .24);
    --ax-info-100: #eef6fc;
    --ax-info-200: #e3eff7;
    --ax-info-300: #d7e6f0;
    --ax-info-400: #c0d6e4;
    ...
    --ax-info-900: #00557d;
    --ax-info-1000: #002942;
    --ax-info-100A: rgba(0, 120, 210, .067);
    ...
    --ax-meta-purple-100A: rgba(107, 0, 255, .047);
    --ax-meta-purple-200A: rgba(115, 0, 255, .08);
    --ax-meta-purple-300A: rgba(101, 0, 232, .13);
    --ax-meta-purple-400A: rgba(94, 0, 216, .204);
    ...
    --ax-meta-lime-300A: rgba(180, 202, 0, .396);
  ...
  .dark {
    ...
    --ax-neutral-400: #2e3641;
    --ax-neutral-500: #656d7b;
    --ax-neutral-600: #777f8d;
    --ax-neutral-700: #8a92a0;
    --ax-neutral-800: #949ba8;
    --ax-neutral-900: #a5acb6;
    --ax-neutral-1000: #dfe1e5;
    --ax-neutral-000: black;
    --ax-neutral-100A: rgba(200, 207, 240, .043);
    --ax-neutral-200A: rgba(202, 209, 246, .075);
    --ax-neutral-300A: rgba(215, 222, 250, .11);
    --ax-neutral-400A: rgba(224, 237, 254, .153);
    --ax-accent-100: #091e37;
    --ax-accent-200: #0b233f;
    --ax-accent-300: #102b4b;
    --ax-accent-400: #17365c;
    --ax-accent-500: #2e6db8;
    --ax-accent-600: #4580ca;
    --ax-accent-700: #5f94d8;
    --ax-accent-800: #6d9ddd;
    --ax-accent-900: #84aee6;
    --ax-accent-1000: #a9cbfa;
    --ax-accent-100A: rgba(0, 103, 250, .11);
    --ax-accent-200A: rgba(0, 118, 251, .145);
    --ax-accent-300A: rgba(24, 131, 251, .2);
    --ax-accent-400A: rgba(47, 142, 254, .275);
    --ax-success-100: #002300;
    --ax-success-200: #002a00;
    --ax-success-300: #030;
    --ax-success-400: #004000;
    --ax-success-500: #207c41;
    --ax-success-600: #378f53;
    --ax-success-700: #4ca265;
    --ax-success-800: #5eab72;
    --ax-success-900: #78ba87;
    --ax-success-1000: #98d7a7;
    --ax-success-100A: rgba(0, 245, 0, .063);
    --ax-success-200A: rgba(0, 254, 0, .09);
    --ax-success-300A: rgba(0, 253, 0, .13);
    --ax-success-400A: rgba(0, 255, 0, .184);
    --ax-warning-100: #371100;
    --ax-warning-200: #3e1704;
    --ax-warning-300: #471f0c;
    --ax-warning-400: #542b18;
    --ax-warning-500: #af5122;
    --ax-warning-600: #c56333;
    --ax-warning-700: #de753c;
    --ax-warning-800: #e78040;
    --ax-warning-900: #ed974b;
    --ax-warning-1000: #ffbc4b;
    --ax-warning-100A: rgba(252, 0, 0, .173);
    --ax-warning-200A: rgba(254, 31, 0, .2);
    --ax-warning-300A: rgba(252, 63, 0, .24);
    --ax-warning-400A: rgba(253, 96, 8, .294);
    --ax-danger-100: #410409;
    --ax-danger-200: #490b10;
    --ax-danger-300: #521517;
    --ax-danger-400: #5f2021;
    --ax-danger-500: #c8343f;
    --ax-danger-600: #de4a50;
    --ax-danger-700: #eb6772;
    --ax-danger-800: #ee7685;
    --ax-danger-900: #f28ea2;
    --ax-danger-1000: #ffb3cd;
    --ax-danger-100A: rgba(255, 0, 0, .21);
    --ax-danger-200A: rgba(252, 0, 0, .247);
    --ax-danger-300A: rgba(255, 21, 3, .282);
    --ax-danger-400A: rgba(255, 54, 37, .337);
    --ax-info-100: #001f35;
    --ax-info-200: #00253c;
    --ax-info-300: #002d46;
    --ax-info-400: #013956;
    ...
    --ax-info-900: #93afc0;
    --ax-info-1000: #b4ccdc;
    --ax-info-100A: rgba(0, 120, 247, .1);
    --ax-info-200A: rgba(0, 141, 249, .133);
    --ax-info-300A: rgba(0, 157, 252, .176);
    --ax-info-400A: rgba(0, 167, 254, .247);
    ...
    --ax-brand-blue-100: #001f35;
    --ax-brand-blue-200: #00253c;
    --ax-brand-blue-300: #002d46;
    --ax-brand-blue-400: #013956;
    --ax-brand-blue-500: #43718d;
    --ax-brand-blue-600: #5b839c;
    --ax-brand-blue-700: #7396ab;
    --ax-brand-blue-800: #7f9fb3;
    --ax-brand-blue-900: #93afc0;
    --ax-brand-blue-1000: #b4ccdc;
    --ax-brand-blue-100A: rgba(0, 120, 247, .1);
    --ax-brand-blue-200A: rgba(0, 141, 249, .133);
    --ax-brand-blue-300A: rgba(0, 157, 252, .176);
    --ax-brand-blue-400A: rgba(0, 167, 254, .247);
    --ax-meta-purple-100: #1f1832;
    --ax-meta-purple-200: #261e3b;
    --ax-meta-purple-300: #2e2546;
    --ax-meta-purple-400: #3a2f55;
    --ax-meta-purple-500: #8157bb;
    --ax-meta-purple-600: #936aca;
    --ax-meta-purple-700: #a581d6;
    --ax-meta-purple-800: #ae8cdb;
    --ax-meta-purple-900: #bb9fe3;
    --ax-meta-purple-1000: #efe4fd;
    --ax-meta-purple-100A: rgba(212, 56, 252, .086);
    --ax-meta-purple-200A: rgba(206, 93, 255, .125);
    --ax-meta-purple-300A: rgba(195, 112, 252, .176);
    --ax-meta-purple-400A: rgba(195, 128, 254, .243);
    --ax-meta-lime-100: #1c1f00;
    --ax-meta-lime-200: #222500;
    --ax-meta-lime-300: #292d00;
    --ax-meta-lime-400: #343900;
    --ax-meta-lime-500: #6a7200;
    --ax-meta-lime-600: #7c8500;
    --ax-meta-lime-700: #8f9800;
    --ax-meta-lime-800: #99a200;
    --ax-meta-lime-900: #a9b325;
    --ax-meta-lime-1000: #c6d200;
  ...
  :root, :host, .light {
    ...
    --ax-bg-overlay: rgba(12, 22, 39, .66);
  ...
  [data-color="neutral"] {
    ...
    --ax-text-decoration: var(--ax-text-neutral-decoration);
  ...
  :root, [data-color="accent"], [data-color=""] {
    ...
    --ax-text-decoration: var(--ax-text-accent-decoration);
  ...
  [data-color="brand-beige"] {
    ...
    --ax-text-decoration: var(--ax-text-brand-beige-decoration);
  ...
  [data-color="brand-blue"] {
    ...
    --ax-text-decoration: var(--ax-text-brand-blue-decoration);
  ...
  [data-color="brand-magenta"] {
    ...
    --ax-text-decoration: var(--ax-text-brand-magenta-decoration);
  ...
  [data-color="info"] {
    ...
    --ax-text-decoration: var(--ax-text-info-decoration);
  ...
  [data-color="success"] {
    ...
    --ax-text-decoration: var(--ax-text-success-decoration);
  ...
  [data-color="warning"] {
    ...
    --ax-text-decoration: var(--ax-text-warning-decoration);
  ...
  [data-color="danger"] {
    ...
    --ax-text-decoration: var(--ax-text-danger-decoration);
  ...
  [data-color="meta-purple"] {
    ...
    --ax-text-decoration: var(--ax-text-meta-purple-decoration);
  ...
  [data-color="meta-lime"] {
    ...
    --ax-text-decoration: var(--ax-text-meta-lime-decoration);
...
@layer aksel.baseline, aksel.print, aksel.typography, aksel.components.core, aksel.components.core.loader, aksel.components.core.button, aksel.components.form, aksel.components.modules, aksel.layout;
