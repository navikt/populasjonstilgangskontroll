...
import no.nav.tilgangsmaskin.felles.rest.cache.CacheAdapter
...
@Component
class StartupInfoContributor(private val ctx: ConfigurableApplicationContext, private  val valKey: CacheAdapter, vararg val regelsett: RegelSett) :
    InfoContributor {
