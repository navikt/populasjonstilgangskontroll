...
@Component
class EntraOppfrisker(private val oidTjeneste: AnsattOidTjeneste, override val cacheName: String = GRAPH) : CacheOppfrisker {
    ...
    override fun oppfrisk(elementer: CacheNøkkelElementer) {
        runCatching {
            ...
            valider(elementer).call(this,ansattId, oidTjeneste.oidFraEntra(ansattId)).also {
                log.info("Oppfrisking ${elementer.nøkkel} etter sletting")
            }
        }.getOrElse {
