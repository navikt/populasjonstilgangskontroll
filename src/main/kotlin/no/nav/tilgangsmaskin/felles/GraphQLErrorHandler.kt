...
interface GraphQLErrorHandler {
    fun handle(uri: URI, e: Throwable): Nothing =
        when (e) {
            ...
            is GraphQlTransportException -> throw no.nav.tilgangsmaskin.felles.RecoverableRestException(
            ...
            else -> throw no.nav.tilgangsmaskin.felles.IrrecoverableRestException(
                INTERNAL_SERVER_ERROR,
                uri,
                e.message ?: "Uventet respons",
                e
    ...
    companion object {
        ...
        private fun oversett(kode: String, msg: String, uri: URI) =
            no.nav.tilgangsmaskin.felles.IrrecoverableRestException(kode.tilStatus(), uri, msg)
