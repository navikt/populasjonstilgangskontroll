...
class BrukerTjenesteTest : BehaviorSpec({
    ...
    Given("brukere") {
        When("input er tom") {
            Then("returneres tom mengde uten å kalle PDL") {
        ...
        When("det finnes flere brukere") {
            Then("slås opp skjerming for alle og SKJERMING-gruppe settes riktig") {
        ...
        When("PDL ikke finner noen personer") {
            Then("returneres tom mengde uten å kalle skjerming") {
        ...
        When("PDL ikke finner alle personer") {
            Then("returneres delmengde med de som ble funnet") {
        ...
        When("person har geografisk tilknytning") {
    ...
    Given("brukerMedNærmesteFamilie") {
        ...
        When("kalles") {
            Then("brukes medFamilie, ikke medUtvidetFamilie") {
                every { pdl.medFamilie(id1.verdi) } returns person(id1, aktørId1)
                every { skjerming.skjerming(id1) } returns false
    ...
    Given("brukerMedUtvidetFamilie") {
        ...
        When("kalles") {
            Then("brukes medUtvidetFamilie, ikke medFamilie") {
                every { pdl.medUtvidetFamilie(id1.verdi) } returns person(id1, aktørId1)
                every { skjerming.skjerming(id1) } returns false
