    ...
    init {
        ...
        Given("partnere") {
            When("sivilstand er GIFT") {
                Then("returneres PARTNER-relasjon") {
            ...
            When("sivilstand er SKILT") {
                Then("returneres TIDLIGERE_PARTNER-relasjon") {
                    server.expect(requestTo(cfg.baseUri))
            ...
            When("sivilstand er UGIFT med partner-ident") {
                Then("returneres INGEN-relasjon") {
                    server.expect(requestTo(cfg.baseUri))
            ...
            When("responsen inneholder blanding av sivilstander med og uten partner") {
