...
object TestData {
    ...
    internal val egenAnsattFortroligAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(fortroligEntraGruppe, egenAnsattEntraGruppe), ansattBruker)
    internal val egenAnsattStrengtFortroligAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(strengtFortroligEntraGruppe, egenAnsattEntraGruppe), ansattBruker)
    internal val strengtFortroligAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(strengtFortroligEntraGruppe), ansattBruker)
    internal val fortroligAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(fortroligEntraGruppe), ansattBruker)
    internal val egenAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(egenAnsattEntraGruppe), ansattBruker)
    internal val egenAnsattMedFamilie = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(annenEntraGruppe), annenAnsattBruker)

    internal val vanligAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(annenEntraGruppe), ansattBruker)
    internal val geoUtlandAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(geoUtlandEntraGruppe), ansattBruker)
    internal val udefinertGeoAnsatt = Ansatt(AnsattIdentifikatorer(ansattId, oid), listOf(udefinertGruppe), ansattBruker)
