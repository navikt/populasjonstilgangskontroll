...
object TestData {
    ...
    internal val egenAnsattFortroligAnsatt = Ansatt(ansattBruker,attributter, fortroligEntraGruppe, egenAnsattEntraGruppe)
    internal val egenAnsattStrengtFortroligAnsatt = Ansatt(ansattBruker,attributter, strengtFortroligEntraGruppe, egenAnsattEntraGruppe)
    internal val strengtFortroligAnsatt = Ansatt(ansattBruker,attributter, strengtFortroligEntraGruppe)
    ...
    internal val udefinertGeoAnsatt = Ansatt(ansattBruker,attributter, udefinertGruppe)
    internal val nasjonalAnsatt = Ansatt(ansattBruker,attributter, nasjonalGruppe)
    internal val enhetAnsatt = Ansatt(ansattBruker,attributter, enhetGruppe)
