    ...
    init {
        ...
        beforeEach { case ->
            ...
            mockMvc = standaloneSetup(
                TilgangController(regelTjeneste, enkeltTilgangTjeneste, TokenTypeGuard(token), konsumentValidator, teller),
                BulkTilgangController(regelTjeneste, TokenTypeGuard(token), teller)
            )
